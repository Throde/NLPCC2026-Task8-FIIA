...
2. Researchers who wish to examine the submitted attack data and the associated annotation and evaluation results, or to use these resources in subsequent analyses, should cite the FIIA shared-task overview paper:
